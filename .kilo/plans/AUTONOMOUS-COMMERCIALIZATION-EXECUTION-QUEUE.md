...
| — | `product.web-browser-acceptance` | continuation scan (contract §9 UI-evidence gap) | Real browser rendering/interaction acceptance for the web surface; no new dependency; reports ENVIRONMENT_BLOCKED without a browser | `scripts/web-browser-acceptance.cjs`, `scripts/final-product-qualification.cjs` | MEDIUM | **COMPLETE** (2026-09-19) |
