HOOSHYAROS AUTONOMOUS CONTINUATION MISSION
...
7. Every implementation requires focused verification.
8. Every capability requires integration validation.
9. Never report changed=true without a real repository change.
10. Never create fake artifacts.
