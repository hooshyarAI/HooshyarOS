...
function repairPrompt(payload) {
  return [
    ...
    'Repair the FIRST concrete failure, audit finding, or unresolved qualification cell in the supplied evidence.',
    ...
    'Add or update a focused regression test and run the relevant verification/acceptance test.',
    'Do not stop at a plan: implement the repair.',
    'Do not create unrelated changes or force-push.',
    'When repair is verified, leave the repository clean; the outer loop handles commit and push.',
    '',
