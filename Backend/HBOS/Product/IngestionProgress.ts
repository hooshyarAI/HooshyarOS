...
const INGESTION_FAILURE_MESSAGES_FA: Record<string, string> = {
  ...
  "financial-report-insufficient-evidence": "تحلیل مالی قابل اعتماد نیست، زیرا بخش‌ها یا اقلام الزامی صورت‌های مالی (ترازنامه و سود و زیان) به‌طور کامل استخراج نشده‌اند.",
  "spreadsheet-statement-ambiguous": "کاربرگ صفحه‌گسترده به‌صورت قطعی صورت مالی یا دفتر تشخیص داده نشد.",
  "spreadsheet-html-content-detected": "محتوای این فایل به‌جای قالب باینری XLS، HTML است و از مسیر استاندارد HTML پردازش می‌شود.",
  "spreadsheet-html-content-unsupported": "فایل با پسوند صفحه‌گسترده در واقع HTML است اما جدول یا متن قابل‌خواندن مالی معتبری ندارد.",
