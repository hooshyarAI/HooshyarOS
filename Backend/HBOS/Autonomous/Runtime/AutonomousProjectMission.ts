...
export class AutonomousProjectMission {
    ...
    private capabilityBacklog(): CapabilityDefinition[] {
        return [
            ...
            { id: "platform.api-gateway", capability: "implement the Phase 2 API Gateway capability", targetEngine: "API Gateway Engine", dependencies: ["Security Layer Engine"], requiredPaths: [join(this.root,"Backend/HBOS/Engines/APIGatewayEngine.ts"),join(this.root,"Backend/HBOS/test/APIGatewayEngine.test.ts"),join(this.root,"Docs/Engines/APIGatewayEngine.md")] },
            ...
            { id: "runtime.reasoning.bridge", capability: "integrate the existing Python reasoning runtime with the canonical HBOS Reasoning Engine", targetEngine: "ReasoningEngine", dependencies: ["Reasoning Engine", "AI Runtime"], requiredPaths: [join(this.root,"Backend/HBOS/Engines/ReasoningEngine.ts"),join(this.root,"Backend/HBOS/Assistant/Autonomous/PythonReasoningAdapter.ts"),join(this.root,"Backend/HBOS/test/PythonReasoningAdapter.test.ts")], evidencePaths: [join(this.root,"Backend/AI_Runtime/reasoning/reasoning_engine.py")] }
,
            { id: "platform.budget-intelligence", capability: "implement Budget Intelligence", targetEngine: "Budget Intelligence Engine", dependencies: ["Financial Intelligence Engine"], requiredPaths: [join(this.root,"Backend/HBOS/Engines/BudgetIntelligenceEngine.ts"),join(this.root,"Backend/HBOS/test/BudgetIntelligenceEngine.test.ts"),join(this.root,"Docs/Engines/BudgetIntelligenceEngine.md")] },
            { id: "platform.tax-intelligence", capability: "implement Tax Intelligence", targetEngine: "Tax Intelligence Engine", dependencies: ["Financial Intelligence Engine"], requiredPaths: [join(this.root,"Backend/HBOS/Engines/TaxIntelligenceEngine.ts"),join(this.root,"Backend/HBOS/test/TaxIntelligenceEngine.test.ts"),join(this.root,"Docs/Engines/TaxIntelligenceEngine.md")] },
            { id: "platform.dashboard", capability: "implement Dashboard capability", targetEngine: "Dashboard Engine", dependencies: ["Executive Intelligence Engine"], requiredPaths: [join(this.root,"Backend/HBOS/Engines/DashboardEngine.ts"),join(this.root,"Backend/HBOS/test/DashboardEngine.test.ts"),join(this.root,"Docs/Engines/DashboardEngine.md")] },
            { id: "platform.reports", capability: "implement Reports capability", targetEngine: "Reports Engine", dependencies: ["Dashboard Engine"], requiredPaths: [join(this.root,"Backend/HBOS/Engines/ReportsEngine.ts"),join(this.root,"Backend/HBOS/test/ReportsEngine.test.ts"),join(this.root,"Docs/Engines/ReportsEngine.md")] },
            { id: "platform.alerts", capability: "implement Alerts capability", targetEngine: "Alerts Engine", dependencies: ["Dashboard Engine"], requiredPaths: [join(this.root,"Backend/HBOS/Engines/AlertsEngine.ts"),join(this.root,"Backend/HBOS/test/AlertsEngine.test.ts"),join(this.root,"Docs/Engines/AlertsEngine.md")] }
        ];
    }
    private isCapabilityImplemented(capability: CapabilityDefinition): boolean {
        return capability.requiredPaths.every(existsSync) && (!capability.evidencePaths || capability.evidencePaths.length === 0 || capability.evidencePaths.some(existsSync));
    }
