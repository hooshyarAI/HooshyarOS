...
export class AutonomousProjectMission {
    ...
    private capabilityBacklog(): CapabilityDefinition[] {
        ...
        return [
            ...
            { id: "platform.security-layer", capability: "implement the Phase 2 Security Layer capability", targetEngine: "Security Layer Engine", dependencies: ["Governance Engine", "User Management Engine", "Organization Model Engine"], requiredPaths: [p("Backend/HBOS/Engines/SecurityLayerEngine.ts"),p("Backend/HBOS/test/SecurityLayerEngine.test.ts"),p("Docs/Engines/SecurityLayerEngine.md")], verificationPaths: focused("Backend/HBOS/test/SecurityLayerEngine.test.ts") },
            ...
            { id: "platform.financial-intelligence", capability: "implement the canonical Financial Intelligence capability", targetEngine: "Financial Intelligence Engine", dependencies: ["Reasoning Engine", "Governance Engine"], requiredPaths: [p("Backend/HBOS/Engines/FinancialIntelligenceEngine.ts"),p("Backend/HBOS/test/FinancialIntelligenceEngine.test.ts"),p("Docs/Engines/FinancialIntelligenceEngine.md")], verificationPaths: focused("Backend/HBOS/test/FinancialIntelligenceEngine.test.ts") },            { id: "platform.budget-intelligence", capability: "implement Budget Intelligence", targetEngine: "Budget Intelligence Engine", dependencies: ["Financial Intelligence Engine"], requiredPaths: [p("Backend/HBOS/Engines/BudgetIntelligenceEngine.ts"),p("Backend/HBOS/test/BudgetIntelligenceEngine.test.ts"),p("Docs/Engines/BudgetIntelligenceEngine.md")], verificationPaths: focused("Backend/HBOS/test/BudgetIntelligenceEngine.test.ts") },
    ...
    private isCapabilityImplemented(capability: CapabilityDefinition): boolean {
        const implementation = capability.requiredPaths.every(existsSync);
        ...
        return this.evidenceAudit.evaluate({
            ...
            test,
            documentation,
            dependenciesSatisfied: dependenciesSatisfied && supportingEvidence,
