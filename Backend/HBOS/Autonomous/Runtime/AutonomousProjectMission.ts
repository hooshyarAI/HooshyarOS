...
export class AutonomousProjectMission {
    ...
    nextMission(): Mission {
        ...
        if (!this.assistantCompletionEvidence()) {
            ...
            // All canonical Assistant artifacts are present and the repository is clean.
            // A failed secondary text/policy marker must not manufacture a new
            // construction mission for already-existing artifacts.
