...
export function createCommercialRuntimeServer(): Server {
    return createServer((req: IncomingMessage, res: ServerResponse) => {
        ...
        if (path === "/") return send(res, 200, "text/html; charset=utf-8", "<!doctype html><html lang=\"fa\"><head><meta charset=\"utf-8\"><title>هوشیار.ai</title><link rel=\"manifest\" href=\"/manifest.webmanifest\"><link rel=\"stylesheet\" href=\"/styles.css\"></head><body><main><h1>هوشیار.ai</h1><script src=\"/app.js\"></script></main></body></html>");
