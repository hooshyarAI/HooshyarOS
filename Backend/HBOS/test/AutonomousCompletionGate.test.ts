...
function seedCanonicalAssistantEvidence(root: string): void {
    const files = [
        ...
        "Backend/HBOS/Autonomous/AutonomousConstructionBridge.ts",
    ...
    writeEvidence(root, "Assistant/SYSTEM_PROMPT.md", "Python-only autonomous construction intelligence of HooshyarOS. You are not a human executive's financial, managerial or commercial advisor.");
    ...
    writeEvidence(root, "Backend/HBOS/Autonomous/AutonomousConstructionBridge.ts", "autonomous-self-healing");
