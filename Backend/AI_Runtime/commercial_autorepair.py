...
def main() -> int:
    # Repair the canonical commercial web knot deterministically. This script is
    # intentionally narrow: it owns only the three roadmap artifacts for the web
    # application shell, then relies on the repository's existing tests/audits.
    files = {
